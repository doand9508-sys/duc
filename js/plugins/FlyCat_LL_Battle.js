 ...
 * @author FlyCat
 * 
 * @param battleFacePicture
 * @text 战斗待机表情
 * @require 1
 * @dir img/menu/
 * @type file
 * 
 * @param battleFacePicture1
 * @text 战斗被打表情
 * @require 1
 * @dir img/menu/
 * @type file
 * 
 * @param battleFacePicture2
 * @text 战斗待机发情表情
 * @require 1
 * @dir img/menu/
 * @type file
 * 
 * @param battleFacePicture3
 * @text 战斗待机控制表情
 * @require 1
 * @dir img/menu/
 * @type file
...
FlyCat.LL_Battle.battleFacePicture = String(FlyCat.LL_Battle.parameters['battleFacePicture']);
FlyCat.LL_Battle.battleFacePicture1 = String(FlyCat.LL_Battle.parameters['battleFacePicture1']);
FlyCat.LL_Battle.battleFacePicture2 = String(FlyCat.LL_Battle.parameters['battleFacePicture2']);
FlyCat.LL_Battle.battleFacePicture3 = String(FlyCat.LL_Battle.parameters['battleFacePicture3']);
...
FlyCat.LL_Battle.djYwState = String(FlyCat.LL_Battle.parameters['djYwState']);
...
PluginManager.registerCommand('FlyCat_LL_Battle', 'hideBattleImg', args => {
    if (FlyCat.LL_Battle._Scene_Battle._battleActorSprite && FlyCat.LL_Battle._Scene_Battle._battleActorStateSprite && FlyCat.LL_Battle._Scene_Battle._battleActorMainSprite) {
        ...
        FlyCat.LL_Battle._Scene_Battle._actorYwSprite.visible = eval(args.type);
...
//     this._battleActorMainSprite.anchor.x = 0.5;
//     this._battleActorMainSprite.anchor.y = 1;
//     this._battleActorMainSprite.x = x;
//     this._battleActorMainSprite.y = y;
//     /*表情*/
//     this._battleActorFaceSprite = new Sprite();
//     this.addChild(this._battleActorFaceSprite);
//     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', FlyCat.LL_Battle.battleFacePicture);
//     //this._battleActorMainSprite.anchor.set(0.5);
//     this._battleActorFaceSprite.anchor.x = 0.5;
//     this._battleActorFaceSprite.anchor.y = 1;
//     this._battleActorFaceSprite.x = x;
//     this._battleActorFaceSprite.y = y;
//     /*淫文*/
//     this._actorYwSprite = new Sprite();//淫文
//     this.addChild(this._actorYwSprite)
//     this._actorYwSprite.anchor.set(0.5);
//     this._actorYwSprite.x = x;
//     this._actorYwSprite.y = y;
//     this._actorYwSprite.anchor.x = 0.5;
//     this._actorYwSprite.anchor.y = 1;
//     /*白浊*/
...
//     this._actorBzSprite.anchor.x = 0.5;
//     this._actorBzSprite.anchor.y = 1;
//     /*衣服*/
...
//     this._battleActorSprite.anchor.x = 0.5;
//     this._battleActorSprite.anchor.y = 1;
//     /*状态*/
...
//     this._battleActorStateSprite.anchor.x = 0.5;
//     this._battleActorStateSprite.anchor.y = 1;
...
//     this._actorFqSprite.anchor.x = 0.5;
//     this._actorFqSprite.anchor.y = 1;
...
//     this._actorKzSprite.anchor.x = 0.5;
//     this._actorKzSprite.anchor.y = 1;
//     /*临时*/
...
//         this.isHpBattleSprite();
//     }
//     if (this._autoType == '战斗' && this._battleActorFaceSprite) {
//         this._beidacishu = 0;
//         this._autoFaceCounts = 0;
//         this._autoFaceRandom = false;
//         this._autoFaceCounts_1 = 0;
//         this._autoFaceSpeed = 10;
//         this._autoFaceNameCounts = 0;
//         this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '战斗立绘普通表情');
//         this._battleActorFaceSprite.x = 950;
//         this._battleActorFaceSprite.y = 722;
//         if ($gameSwitches.value(FlyCat.LL_SceneMenu.fqSwitch)) {//发情
//             this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '战斗立绘发情表情');
//         }
//         if ($gameSwitches.value(FlyCat.LL_SceneMenu.kzSwitch)) {//控制
//             this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '战斗立绘控制表情');
//         };
//     } else if (this._autoType == '被打' && this._battleActorFaceSprite) {
//         this._autoFaceCounts = 0;
//         this._autoFaceRandom = false;
//         this._autoFaceCounts_1 = 0;
//         this._autoFaceSpeed = 10;
//         this._autoFaceNameCounts = 0;
//         this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', FlyCat.LL_Battle.battleFacePicture1);
//         this._battleActorFaceSprite.x = 950;
//         this._battleActorFaceSprite.y = 722;
//         this._beidacishu++;
...
//     } else if (this._autoType == '待机' && this._battleActorFaceSprite) {
//         this._beidacishu = 0;
//         this._autoFaceCounts++;
//         if (!this._autoFaceRandom) {
//             if (this._autoFaceCounts >= this._autoFaceSpeed) {
//                 var picture = FlyCat.LL_Battle.battleFacePicture;
//                 if ($gameSwitches.value(FlyCat.LL_SceneMenu.fqSwitch)) {//发情
//                     var picture = FlyCat.LL_Battle.battleFacePicture2;
//                 }
//                 if ($gameSwitches.value(FlyCat.LL_SceneMenu.kzSwitch)) {//控制
//                     var picture = FlyCat.LL_Battle.battleFacePicture3;
//                 };
//                 if (this._autoFaceNameCounts == 0) {
//                     var img = picture;
//                 } else {
//                     var img = picture + this._autoFaceNameCounts;
//                 }
//                 this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', img);
//                 this._autoFaceNameCounts++;
//                 if (this._autoFaceNameCounts > 5) {
//                     this._autoFaceNameCounts = 0;
...
//         }
//     }
//     if (this._battleActorMainSprite && this._actorBzSprite && this._battleActorSprite
//         && this._battleActorStateSprite && this._actorFqSprite && this._actorKzSprite
//         && this._battleActorFaceSprite && this._actorYwSprite) {
//         this._breatheBattleCount++;
//         if (this._breatheBattleCount < 61) {
//             this._battleActorMainSprite.scale.y += 0.0002;
//             this._battleActorSprite.scale.y += 0.0002;
//             this._battleActorStateSprite.scale.y += 0.0002;
//             this._actorBzSprite.scale.y += 0.0002;
//             this._actorYwSprite.scale.y += 0.0002;
//             this._actorFqSprite.scale.y += 0.0002;
//             this._actorKzSprite.scale.y += 0.0002;
//             this._battleActorFaceSprite.scale.y += 0.0002;
//         }
...
//         else {
//             this._breatheBattleCount = 0;
//             this._battleActorMainSprite.scale.y = 1;
//             this._battleActorSprite.scale.y = 1;
//             this._battleActorStateSprite.scale.y = 1;
//             this._actorBzSprite.scale.y = 1;
//             this._actorYwSprite.scale.y = 1;
//             this._actorFqSprite.scale.y = 1;
//             this._actorKzSprite.scale.y = 1;
//             this._battleActorFaceSprite.scale.y = 1;
//         };
//     }
...
//         this._actorYwSprite.visible = !switchs;
//         this._actorFqSprite.visible = !switchs;
//         this._actorKzSprite.visible = !switchs;
//         this._battleActorFaceSprite.visible = !switchs;
//     }
// };
Scene_Battle.prototype.isActorStates = function (type) {
    ...
    var value_1 = '';
    var value_2 = '';
    this._battleActorFaceSprite.x = 1000;
    this._battleActorFaceSprite.y = 720;
    this._autoType = type;
    if (type === '战斗') {
    ...
    //     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '');
    //     var x = 800;
    // };
    if (type === '待机') {
        ...
        var value_3 = FlyCat.LL_Battle.djYwState;
        //  this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', FlyCat.LL_Battle.battleFacePicture);
        var x = 1000;
    };
    if (type === '被打') {
    ...
    if ($gameSwitches.value(FlyCat.LL_SceneMenu.ywSwitch)) {//淫文
        this._actorYwSprite.bitmap = ImageManager.loadBitmap('img/menu/', value_3);
    } else {
        this._actorYwSprite.bitmap = '';
    }
    if ($gameSwitches.value(FlyCat.LL_SceneMenu.fqSwitch)) {//发情
        // if (type === '待机') {
        //     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', FlyCat.LL_Battle.battleFacePicture2);
        // }
        // if (type === '战斗') {
        //     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '战斗立绘发情表情');
        // };
    ...
    if ($gameSwitches.value(FlyCat.LL_SceneMenu.kzSwitch)) {//控制
        // if (type === '待机') {
        //     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', FlyCat.LL_Battle.battleFacePicture3);
        // }
        // if (type === '战斗') {
        //     this._battleActorFaceSprite.bitmap = ImageManager.loadBitmap('img/menu/', '战斗立绘控制表情');
        // };
    ...
    //  this._battleActorStateSprite.x = x;
    if (type === '战斗') {
        this._actorYwSprite.x = x + 140;
        this._actorBzSprite.x = x + 140;
        this._actorFqSprite.x = x;
        this._actorKzSprite.x = x;
    } else {
        this._actorBzSprite.x = x;
...
Scene_Battle.prototype.isHpBattleSprite = function () {
    ...
    var img = '';
	const lv = $we.breakClothLv(this._actorArmor);
	if (lv == 0) {
		$gameSystem._battlePicture = '';
	} else {
		img = '战斗' + String($gameSystem._battlePicture + lv);
	}
...
Scene_Battle.prototype.isHpBattleSkillSprite = function () {
	...
	if (lv == 0) {
		...
		img = '施法' + String($gameSystem._battlePicture + lv);
	}
...
Scene_Battle.prototype.isHpBattleAtkSprite = function () {
    ...
    this._battleActorMainSprite.x = 950;
    var img = '';
	const lv = $we.breakClothLv(this._actorArmor);
	if (lv == 0) {
		$gameSystem._battlePicture = '';
	} else {
		img = '鞭子' + String($gameSystem._battlePicture + lv);
	}
    if (this._lastBattleAtkImg != img || this._lastBattleAtkImg == null) {
        this._battleActorSprite.x = 950;
        this._battleActorSprite.bitmap = ImageManager.loadBitmap('img/menu/', img);
    }
...
Game_Actor.prototype.performDamage = function () {
    ...
    if (this._actorId == 1) {
        FlyCat.LL_Battle._Scene_Battle.isActorStates('被打');
...
Scene_Battle.prototype.isHpBattleDamageSprite = function () {
	...
	if (lv == 0) {
		...
		img = '被打' + String($gameSystem._battlePicture + lv);
	}
...
Spriteset_BattleAnimation.prototype.update = function () {
    ...
    if (this._actorSprites) {
        this.updateActors()
        if (this._actorSprites[1] && SceneManager._scene._battlePetMainSprite) {
            this._actorSprites[1].setHome(SceneManager._scene._battlePetMainSprite.x - 340,
                SceneManager._scene._battlePetMainSprite.y - 500);
        }
    };
