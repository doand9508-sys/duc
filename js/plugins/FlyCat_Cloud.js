...
Scene_Map.prototype.createDisplayObjects = function () {
    ...
    if ($dataMap && $dataMap.meta) this.createCloudSprite();
};
...
Scene_Map.prototype.update = function () {
    ...
    if (this._mapMeta) {
        if (this._lastDisplayX != $gameMap.displayX()) {
            var value = this._lastDisplayX - $gameMap.displayX();
            var value = value * $gameMap.tileWidth();
            this._cloudSprite.origin.x -= value;
            this._lastDisplayX = $gameMap.displayX()
        }
        if (this._lastDisplayY != $gameMap.displayY()) {
            var value = this._lastDisplayY - $gameMap.displayY();
            var value = value * $gameMap.tileHeight();
            this._cloudSprite.origin.y -= value;
            this._lastDisplayY = $gameMap.displayY()
        }
