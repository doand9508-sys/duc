...
FlyCat.LL_Hy.Scene_LL_HY_createBackground = Scene_LL_HY.prototype.createBackground;
Scene_LL_HY.prototype.createBackground = function () {
    FlyCat.LL_Hy.Scene_LL_HY_createBackground.call(this);
    this._backgroundSprite_new = new Sprite();
    this._backgroundSprite_new.bitmap = ImageManager.loadBitmap('img/menu/', 'hzBack');
    this.addChild(this._backgroundSprite_new);
};
Scene_LL_HY.prototype.createForGroundSprite = function () {
    this._forgroundSprite_new = new Sprite();
    this._forgroundSprite_new.bitmap = ImageManager.loadBitmap('img/menu/', 'backLay');
    this.addChild(this._forgroundSprite_new);
...
Scene_LL_HY.prototype.createChlidrenMenPaiWindow = function () {
    ...
    this._menPaiBackGroundSprite.bitmap = ImageManager.loadBitmap('img/menu/', "mpback");

    this._menPaiBackGroundSprite_2 = new Sprite();
    this.addChild(this._menPaiBackGroundSprite_2);
    this._menPaiBackGroundSprite_2.hide();
    this._menPaiBackGroundSprite_2.bitmap = ImageManager.loadBitmap('img/menu/', "mpback2");
    ...
    this._itemBackGroundSprite.bitmap = ImageManager.loadBitmap('img/menu/', "pyback");
    ...
    // this._itemBackGroundSprite_2.bitmap = ImageManager.loadBitmap('img/menu/', "培养背景");
...
Scene_LL_HY.prototype.chlidrenMenPaiWindowRect = function () {
    ...
    const wy = Graphics.height / 2 - wh / 2 + 20;
...
Scene_LL_HY.prototype.okChildrenMenPai = function () {//确定门派
    ...
    this._menPaiBackGroundSprite.hide();
    this._cancelMenPaiButtonSprite.hide();
    this._menPaiBackGroundSprite_2.show();
};
...
Scene_LL_HY.prototype.createChlidrenItemWindow = function () {
    this._cancelItemButtonSprite = new Sprite_CancelButton();
    this.addChild(this._cancelItemButtonSprite);
    this._cancelItemButtonSprite.bitmap = ImageManager.loadBitmap('img/menu/', 'closeButton');
    this._cancelItemButtonSprite.setClickHandler(this.cancelChildrenItem.bind(this));
    this._cancelItemButtonSprite.hide();
    this._cancelItemButtonSprite.x = 813;
    this._cancelItemButtonSprite.y = 166;
...
Scene_LL_HY.prototype.createCommandSprite = function () {
    ...
    for (let i = 0; i < 7; i++) {
        ...
        this._hyButtonSprite[i].bitmap = ImageManager.loadBitmap('img/menu/', "hy_button_" + i)
...
Scene_LL_HY.prototype.BsChildren = function () {//出嫁
    ...
    this._menPaiBackGroundSprite.show();
    this._cancelMenPaiButtonSprite.show();
};
...
Scene_LL_HY.prototype.createChlidrenListWindow = function () {
    ...
    else if (this._chListWindow._list) {
...
Window_ChildrenMenPai.prototype.update = function () {
...
Window_ChildrenMenPai.prototype.drawCursorBitmap = function (rect, type) {
...
Window_ChildrenMenPai.prototype.drawBackgroundRect = function (rect) {
};
Window_ChildrenMenPai.prototype._updateCursor = function () {
...
Window_ChildrenMenPai.prototype.refresh = function () {
    ...
    this._list = ['\\C[23]【正派】\\C[0]傲天门', '\\C[23]【正派】\\C[0]灵兽宗', '\\C[10]【邪派】\\C[0]欢喜宗', '\\C[10]【邪派】\\C[0]血神阁', '\\C[24]【中立】\\C[0]炎火阁', '\\C[24]【中立】\\C[0]凌霄宫'];
...
Window_ChildrenMenPai.prototype.processColorChange = function (colorIndex) {
    if (colorIndex == 0) {
...
FlyCat.LL_Hy.Window_ChildrenMenPai_select = Window_ChildrenMenPai.prototype.select;
Window_ChildrenMenPai.prototype.select = function (index) {
    FlyCat.LL_Hy.Window_ChildrenMenPai_select.call(this, index)
...
Window_ChildrenItem.prototype.drawCursorBitmap = function (rect, type) {
    const bitmap = this._loadBitmap;
    if (bitmap) {
        const pw = bitmap.width;
        const ph = bitmap.height / 2;
...
Window_ChildrenItem.prototype.update = function () {
    Window_Selectable.prototype.update.call(this);
    if (!this._loadingPictrue && this._loadBitmap && this._loadBitmap.isReady()) {
        this.refresh();
        if (this._list && this._list.length > 0) {
...
Window_ChildrenItem.prototype._updateCursor = function () {
    this._cursorSprite.alpha = 0;
    this._cursorSprite.visible = this.isOpen() && this.cursorVisible;
    this._cursorSprite.x = this._cursorRect.x;
    this._cursorSprite.y = this._cursorRect.y;
};
Window_ChildrenItem.prototype.drawBackgroundRect = function (rect) {
};
...
FlyCat.LL_Hy.Window_ChildrenItem_select = Window_ChildrenItem.prototype.select;
Window_ChildrenItem.prototype.select = function (index) {
    FlyCat.LL_Hy.Window_ChildrenItem_select.call(this, index)
    if (index >= 0 && index < this.maxItems() && index != this.lastselect) {
        this.refresh();
        this.lastselect = index;
    }
...
Window_ChildrenMessage.prototype.processColorChange = function (colorIndex) {
    if (colorIndex == 0) {
        this.changeTextColor('#4e7574');
        this.contents.outlineColor = '#adbeb4';
        this.contents.outlineWidth = 1;
    } else if (colorIndex == 3 || colorIndex == 23 || colorIndex == 10) {
        this.changeTextColor('#e73f3f');
        this.contents.outlineColor = '#edb7af';
        this.contents.outlineWidth = 1;
    } else {
        this.changeTextColor(ColorManager.textColor(colorIndex));
        this.contents.outlineColor = ColorManager.textColor(colorIndex);
        this.contents.outlineWidth = 1;
    }
};
Window_ChildrenMessage.prototype.drawBackgroundRect = function (rect) {
};
...
Window_ChildrenOk.prototype.initialize = function (rect) {
    ...
    this._loadingPictrue = true;
    this.lastselect = -1;
    this._loadBitmap = ImageManager.loadBitmap('img/menu/', 'hyqd');
    this._loadBitmap_1 = ImageManager.loadBitmap('img/menu/', 'hyqx');
};

Window_ChildrenOk.prototype.update = function () {
    Window_Selectable.prototype.update.call(this);
    if (!this._loadingPictrue && this._loadBitmap && this._loadBitmap.isReady() && this._loadBitmap_1 && this._loadBitmap_1.isReady()) {
        this.drawTextType();
...
FlyCat.LL_Hy.Window_ChildrenOk_select = Window_ChildrenOk.prototype.select;
Window_ChildrenOk.prototype.select = function (index) {
    FlyCat.LL_Hy.Window_ChildrenOk_select.call(this, index)
    if (index >= 0 && index < this.maxItems() && index != this.lastselect) {
        this.drawAllItems();
        this.lastselect = index;
    }
...
Window_ChildrenOk.prototype.processColorChange = function (colorIndex) {
    ...
    if (colorIndex == 0) {
        ...
        this.changeTextColor('#cd9323');
        this.contents.outlineColor = '#daae5e';
        this.contents.outlineWidth = 1;
    }
    else {
        this.changeTextColor(ColorManager.textColor(colorIndex));
...
Window_ChildrenOk.prototype.zongMen = function (menPai) {
    ...
    const ziSeList = ['丑陋无比', '平平无奇', '眉清目秀', '秀色可餐', '明眸皓齿', '出水芙蓉', '国色天香'];
    ...
    switch (menPai) {
        case '欢喜宗':
            ...
            var text1 = ' \\C[14]√';
            var text2 = ' \\C[14]√';
            this.drawTextEx('\\C[10]【邪】\\C[0]欢喜宗外门收徒标准：', x, y, this.width, 'left');
            const index = ziSeList.indexOf(ziSe);
            if (index < 2) var text = '\\C[10](姿色未达标)';
            if (meiLi < 50) var text1 = '\\C[10](技艺值不足50点)';
            this.drawTextEx('\\C[14]姿色要求：\\C[3]出水芙蓉' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]技艺要求：\\C[3]50' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            this.drawTextEx('\\C[10]【邪】\\C[0]欢喜宗内门收徒标准：', x, y + 90, this.width, 'left');
            if (meiLi < 100) var text1 = '\\C[10](技艺值不足100点)';
            if (lingGen != '水') var text2 = '\\C[10](灵根不符合要求)';
            this.drawTextEx('\\C[14]姿色要求：\\C[3]出水芙蓉' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]技艺要求：\\C[3]100' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]水灵根' + text2, x, y + 162, this.width, 'left');
            ...
            this.drawTextEx('\\C[10]【邪】\\C[0]欢喜宗真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]姿色要求：\\C[3]国色天香' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]技艺要求：\\C[3]200' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]水灵根' + text2, x, 310, this.width, 'left');
        ...
        case '血神阁':
            ...
            var text1 = ' \\C[14]√';
            var text2 = ' \\C[14]√';
            this.drawTextEx('\\C[10]【邪】\\C[0]血神阁外门收徒标准：', x, y, this.width, 'left');
            ...
            this.drawTextEx('\\C[14]性格要求：\\C[3]阴险' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]长短要求：\\C[3]10' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            this.drawTextEx('\\C[10]【邪】\\C[0]血神阁内门收徒标准：', x, y + 90, this.width, 'left');
            if (changDuan == null) {
                var text1 = '\\C[10](性别不符合标准)';
            ...
            this.drawTextEx('\\C[14]性格要求：\\C[3]阴险' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]长短要求：\\C[3]20' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]火灵根' + text2, x, y + 162, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 2;
            /*真传*/
            if (changDuan == null) {
                var text1 = '\\C[10](性别不符合标准)';
            ...
            this.drawTextEx('\\C[10]【邪】\\C[0]血神阁真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]性格要求：\\C[3]阴险' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]长短要求：\\C[3]30' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]火/土灵根' + text2, x, 310, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 3;
            break;
        case '傲天门':
            /*外门*/
            ...
            var text1 = ' \\C[14]√';
            var text2 = ' \\C[14]√';
            this.drawTextEx('\\C[23]【正】\\C[0]傲天门外门收徒标准：', x, y, this.width, 'left');
            if (xingGe != '忠诚') var text = '\\C[10](性格未达标)';
            if (wuXing < 50) var text1 = '\\C[10](悟性不足50点)';
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]悟性要求：\\C[3]50' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            var text2 = ' \\C[14]√'
            ...
            this.drawTextEx('\\C[23]【正】\\C[0]傲天门内门收徒标准：', x, y + 90, this.width, 'left');
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]悟性要求：\\C[3]70' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]金/土灵根' + text2, 2, y + 162, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 2;
            /*真传*/
            var text2 = ' \\C[14]√'
            ...
            this.drawTextEx('\\C[23]【正】\\C[0]傲天门真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]悟性要求：\\C[3]100' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]天/金灵根' + text2, x, 310, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 3;
            break;
        case '灵兽宗':
            /*外门*/
            ...
            var text1 = ' \\C[14]√'
            var text2 = ' \\C[14]√'
            this.drawTextEx('\\C[23]【正】\\C[0]灵兽宗外门收徒标准：', x, y, this.width, 'left');
            if (xingGe != '开朗') var text = '\\C[10](性格未达标)';
            if (fuYuan < 50) var text1 = '\\C[10](福源不足50点)';
            this.drawTextEx('\\C[14]性格要求：\\C[3]开朗' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]50' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            this.drawTextEx('\\C[23]【正】\\C[0]灵兽宗内门收徒标准：', x, y + 90, this.width, 'left');
            if (fuYuan < 70) var text1 = '\\C[10](福源不足70点)';
            if (lingGen != '木') var text2 = '\\C[10](灵根不符合要求)';
            this.drawTextEx('\\C[14]性格要求：\\C[3]开朗' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]70' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]木灵根' + text2, x, y + 162, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 2;
            /*真传*/
            var text2 = ' \\C[14]√'
            ...
            this.drawTextEx('\\C[23]【正】\\C[0]灵兽宗真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]性格要求：\\C[3]开朗' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]100' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]天/木灵根' + text2, x, 310, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 3;
            break;
        case '雪月门':
            /*外门*/
            ...
            var text1 = ' \\C[14]√';
            var text2 = ' \\C[14]√';
            this.drawTextEx('\\C[24]【中】\\C[0]雪月门外门收徒标准：', x, y, this.width, 'left');
            if (wuXing < 30) var text = '\\C[10](悟性不足30点)';
            if (fuYuan < 50) var text1 = '\\C[10](福源不足50点)';
            this.drawTextEx('\\C[14]悟性要求：\\C[3]30' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]50' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            this.drawTextEx('\\C[24]【中】\\C[0]雪月门内门收徒标准：', x, y + 90, this.width, 'left');
            if (wuXing < 60) var text = '\\C[10](悟性不足60点)';
            if (fuYuan < 70) var text1 = '\\C[10](福源不足70点)';
            if (lingGen != '冰') var text2 = '\\C[10](灵根不符合要求)';
            this.drawTextEx('\\C[14]悟性要求：\\C[3]60' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]70' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]冰灵根' + text2, x, y + 162, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 2;
            /*真传*/
            var text2 = ' \\C[14]√'
            ...
            this.drawTextEx('\\C[24]【中】\\C[0]雪月门真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]悟性要求：\\C[3]90' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]福源要求：\\C[3]100' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]天/冰灵根' + text2, x, 310, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 3;
            break;
        case '凌霄宫':
            /*外门*/
            ...
            var text1 = ' \\C[14]√';
            var text2 = ' \\C[14]√';
            this.drawTextEx('\\C[24]【中】\\C[0]凌霄宫外门收徒标准：', x, y, this.width, 'left');
            if (xingGe != '忠诚') var text = '\\C[10](性格未达标)';
            const index1 = ziSeList.indexOf(ziSe);
            if (index1 < 1) var text1 = '\\C[10](姿色未达标)';
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, y + ofy, this.width, 'left');
            this.drawTextEx('\\C[14]姿色要求：\\C[3]秀色可餐' + text1, x, y + ofy * 2, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√') $gameTemp._menPaiId = 1;
            /*内门*/
            this.drawTextEx('\\C[24]【中】\\C[0]凌霄宫内门收徒标准：', x, y + 90, this.width, 'left');
            if (index1 < 2) var text1 = '\\C[10](姿色未达标)';
            if (lingGen != '水') var text2 = '\\C[10](灵根不符合要求)';
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, y + 114, this.width, 'left');
            this.drawTextEx('\\C[14]姿色要求：\\C[3]出水芙蓉' + text1, x, y + 138, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]水灵根' + text2, x, y + 162, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 2;
            /*真传*/
            var text2 = ' \\C[14]√';
            ...
            this.drawTextEx('\\C[24]【中】\\C[0]凌霄宫真传弟子收徒标准：', x, 238, this.width, 'left');
            this.drawTextEx('\\C[14]性格要求：\\C[3]忠诚' + text, x, 262, this.width, 'left');
            this.drawTextEx('\\C[14]姿色要求：\\C[3]国色天香' + text1, x, 286, this.width, 'left');
            this.drawTextEx('\\C[14]灵根要求：\\C[3]天/水灵根' + text2, x, 310, this.width, 'left');
            if (text === ' \\C[14]√' && text1 === ' \\C[14]√' && text2 === ' \\C[14]√') $gameTemp._menPaiId = 3;
            break;
    }
...
Window_ChildrenOk.prototype.drawCursorBitmap = function (rect, index) {
    if (index == 0) {
        var bitmap = this._loadBitmap;
    } else {
        var bitmap = this._loadBitmap_1;
    }
    if (this.index() == index) {
        var type = 0;
    } else {
    ...
    if (bitmap) {
        ...
        if (this._hdType == 'BS') {
            var dx = rect.x + 24;
            var dy = rect.y - 8;
        } else if (this._hdType == 'MC' || this._hdType == 'CJ') {
            var dx = rect.x + 24;
            var dy = rect.y// + 84;
        } else {
            var dx = rect.x + 24;
...
Window_ChildrenOk.prototype._updateCursor = function () {
    this._cursorSprite.alpha = 0;
    this._cursorSprite.visible = this.isOpen() && this.cursorVisible;
    this._cursorSprite.x = this._cursorRect.x;
    this._cursorSprite.y = this._cursorRect.y;
...
Window_ChildrenOk.prototype.itemRect = function (index) {
    ...
    if (this._hdType == 'BS') {
        var y = row * itemHeight + rowSpacing / 2 - this.scrollBaseY() + 150 + this._offY;
    } else if (this._hdType == 'SX') {
        var y = row * itemHeight + rowSpacing / 2 - this.scrollBaseY() + 150 + this._offY + 96;
    } else {
        var y = row * itemHeight + rowSpacing / 2 - this.scrollBaseY() + 150 + this._offY + 86;
    }
...
Window_ChildrenList.prototype.initialize = function (rect) {
    ...
    this.opacity = 0;
    this._loadingPictrue = false;
    this._loadBitmap = ImageManager.loadBitmap('img/menu/', 'hylb');
    this.activate();
    // this.refresh();
};
Window_ChildrenList.prototype.drawCursorBitmap = function (rect, type) {
    const bitmap = this._loadBitmap;
    if (bitmap) {
        const pw = bitmap.width;
        const ph = bitmap.height / 2;
...
Window_ChildrenList.prototype.update = function () {
    Window_Selectable.prototype.update.call(this);
    if (!this._loadingPictrue && this._loadBitmap && this._loadBitmap.isReady()) {
        this.refresh();
        if (this._list && this._list.length > 0) {
            this.select(0);
            SceneManager._scene._childrenPyWindow.show();
        } else {
            this.select(-1);
            SceneManager._scene._childrenPyWindow.hide();
        }
        this._loadingPictrue = true;
    }
};
Window_ChildrenList.prototype._updateCursor = function () {
    this._cursorSprite.alpha = 0;
    this._cursorSprite.visible = this.isOpen() && this.cursorVisible;
    this._cursorSprite.x = this._cursorRect.x;
    this._cursorSprite.y = this._cursorRect.y;
};
Window_ChildrenList.prototype.drawBackgroundRect = function (rect) {
};
Window_ChildrenList.prototype.refresh = function () {
    ...
    if (this._list.length > 0) {
        ...
        if (SceneManager._scene._childrenInfoWindow) {
            SceneManager._scene._childrenInfoWindow._children = null;
            SceneManager._scene._childrenInfoWindow._childrenLoading = false;
            SceneManager._scene._childrenInfoWindow.contents.clear();
            SceneManager._scene._childrenInfoWindow.contentsBack.clear();
        };
...
Window_ChildrenList.prototype.drawItem = function (index) {
    ...
    if (children) {
        ...
        this.contents.outlineColor = '#587c7a';
        this.contents.outlineWidth = 1;
        this.drawText(children.name, rect.x - 10, rect.y, this._loadBitmap.width, 'center')
    }
}
...
Window_ChildrenInfo.prototype.refresh_1 = function () {
    ...
    if (this._childrenLoading) {
        ...
        this.changeTextColor('#cd9323');
        this.contents.outlineColor = '#e3c787';
        this.contents.outlineWidth = 1;
        ...
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(meiLi, x + textW + ofw, y, this.width, 'left')

        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('性别：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(xingBie, x + textW, y - 1, this.width, 'left')

        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('悟性：', x + 200, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(wuXing, x + textW + ofw, y - 1, this.width, 'left')

        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('性格：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(xingGe, x + textW, y - 2, this.width, 'left')

        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('体力：', x + 200, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(shenLi, x + textW + ofw, y - 2, this.width, 'left')

        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('姿色：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(ziSe, x + textW, y - 2, this.width, 'left')

        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('福源：', x + 200, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(fuYuan, x + textW + ofw, y - 2, this.width, 'left')

        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('灵根：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(lingGen + '灵根', x + textW, y - 3, this.width, 'left')

        //this.changeTextColor(ColorManager.textColor(0));
        if (xiongWei != null) {
            // this.drawText('胸围：', x + 200, y, this.width, 'left')
            // this.changeTextColor(ColorManager.textColor(14));
            this.drawText(xiongWei, x + textW + ofw, y - 3, this.width, 'left');
        }
        else {
            // this.drawText('长短：', x + 200, y, this.width, 'left')
            // this.changeTextColor(ColorManager.textColor(14));
            this.drawText(changDuan, x + textW + ofw, y - 3, this.width, 'left');
        }
        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('仙龄：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(xianLing, x + textW, y - 3, this.width, 'left');

        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('好感：', x + 200, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(haoGanDu, x + textW + ofw, y - 3, this.width, 'left')
        y += ofy;
        // this.changeTextColor(ColorManager.textColor(0));
        // this.drawText('外貌：', x, y, this.width, 'left')
        // this.changeTextColor(ColorManager.textColor(14));
        this.drawText(waiMao, x + textW, y - 3, this.width, 'left');
        // this.changeTextColor(ColorManager.textColor(0));
...
function Sprite_HYCommandButton() {
    this.initialize(...arguments);
}
Sprite_HYCommandButton.prototype = Object.create(Sprite_Clickable.prototype);
Sprite_HYCommandButton.prototype.constructor = Sprite_HYCommandButton;

Sprite_HYCommandButton.prototype.initialize = function () {
    Sprite_Clickable.prototype.initialize.call(this);
    this._clickHandler = null;
    this._buttonId = -1;
};

Sprite_HYCommandButton.prototype.onClick = function () {
    if (SceneManager._scene._childrenPyWindow.active) {
        SceneManager._scene._childrenPyWindow.select(this._buttonId);
        SceneManager._scene._childrenPyWindow.processOk();
    } else {
        SoundManager.playBuzzer();
    }
};

Sprite_HYCommandButton.prototype.onMouseEnter = function () {
    if (SceneManager._scene._childrenPyWindow.active) {
        SceneManager._scene._childrenPyWindow.select(this._buttonId);
...
Sprite_HYCommandButton.prototype.update = function () {
    Sprite_Clickable.prototype.update.call(this);
    const index = SceneManager._scene._childrenPyWindow.index();
...
Sprite_HYCommandButton.prototype.onMouseExit = function () {
    this._colorTone = [0, 0, 0, 0]
    this._updateColorFilter();
};
Sprite_HYCommandButton.prototype.setClickHandler = function (method) {
