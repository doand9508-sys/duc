...
Moghunter.hpgauge_a_xa = Number(Moghunter.parameters['Actor Layout X-Axis'] || 5);
Moghunter.hpgauge_a_ya = Number(Moghunter.parameters['Actor Layout Y-Axis'] || -90);
...
HPGaugeSprite.prototype.refreshRedMeter = function () {
	this._meter[0].value1 = this.update_dif(this._meter[0].value1, this.battler().hp, 30, 1);
	this.refreshMeter(this._meter[0], this._meter[0].value1, this.battler().mhp, 1);
};
...
HPGaugeSprite.prototype.posX = function () {
	...
	return this._sprite.x + xs + this.battler()._ehpgauge[1] + this._xf;
};
...
HPGaugeSprite.prototype.posY = function () {
	return this._sprite.y + this.battler()._ehpgauge[2] + this._yf;
};
